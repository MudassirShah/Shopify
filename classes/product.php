<?php
	...
	class Product{
		...
		public function viewAllCategories(){
			$this->query = "select distinct category.name as 'name',category.id as 'id' from product,category where product.category_id=category.id";
			$result = $this->db->executeQuery($this->query,array(),"sread");
			return $result;
		}

		public function viewAllCategoriesById($id){
			$this->query = "select product.name as 'name',product.image'image',product.id 'id',product.price 'price',product.quantity 'quantity' from product,category where product.category_id=category.id and category.id = ?";
			$result = $this->db->executeQuery($this->query,array($id),"cread");
			return $result;
		}
		

		function searchProductById($productName){
				$this->query = "select * from product where name=?";
		...
		// function serchProductsByNameAndCategory($productName,$categoryId){
		// 	$this->query = "select * from product where name=? And category_id=?";
		// 	$result = $this->db->executeQuery($this->query,array($productName,$categoryId),"cread");
		// 	return $result;
		// }
