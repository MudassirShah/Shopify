...
if(isset($_POST['login'])){
  $user = new User();
  $user->loginUser($_POST['id'],$_POST['password']);
}
?>
    ...
    <div class="col-md-4">
      <section class="login-form">
        <form method="post" action="#" role="login">
          ...
          <h3 id="l1" > </h3>
          <input type="text" name="id" placeholder="ID" onkeypress=""  required class="form-control input-lg" maxlength="11" />
