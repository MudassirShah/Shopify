						...
						<div class="product-single">
							...
							<div class="row">
								...
								<div class="col-lg-5 col-md-5 col-sm-5 product-single-image">
										...
										<ul class="slides">
											<li>
												<img class="cloud-zoom" src="" data-large="" alt="images/NoImage.png.jpg" onerror="">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 product-single-info">
									...
									<span class="price"><!--<del>$381.00</del>--></span>
											...
											<td>
												<div class="numeric-input">
													...
													<span class="add-to-cart" >
														...
														<span class="action-name" onclick="">Add to cart</span>
														</span >
													</span>
